...
usage () {
  ...
  echo "Usage:"
  echo ""
  echo "  $THISSCRIPT -d <target db sid> -l <local backup dir > -p <src backup sys password> -s <s3 src backup dir>"
  echo ""
...
typeset -l PRODUCT=UNSPECIFIED
typeset -l ENV=UNSPECIFIED
